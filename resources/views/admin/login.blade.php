              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Chào mừng bạn quay trở lại !</h1>
                  </div>
                  ...
                  <form class="user" action="{!! route('admin.postLogin') !!}" method="POST">
                    ...
                    <div class="form-group">
                      <input type="email" name="txtEmail" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Vui lòng nhập email">
                    </div>

                    <div class="form-group">
                      <input type="password" name="txtPassword" class="form-control form-control-user" id="exampleInputPassword" placeholder="Vui lòng nhập mật khẩu">
                    </div>
